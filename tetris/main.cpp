...
const std::string BackgroundFile = "meta/background.jpg";
const std::string LogoFile = "meta/notcurses.png";

class Tetris
{
public:
  Tetris(ncpp::NotCurses &nc, std::atomic_bool &gameover) : nc_(nc),
                                                            score_(0),
                                                            curpiece_(nullptr),
                                                            board_(nullptr),
                                                            backg_(nullptr),
